/**
 *  This iot protocol is based in the My Sensors protocol, intended to be compatible with controllers already in existance. However, some features are not supported
 *  as presentation. In this case, the presentation is done by the controller to the attached sensors.
 *
 *
 */
